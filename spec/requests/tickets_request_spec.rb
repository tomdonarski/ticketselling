...
RSpec.describe "Tickets", type: :request do
  ...
  # end
  #
  describe "POST tickets#buy_ticket" do
    ...
    context "reservation exists" do
      ...
      context "card error" do
        let(:params) { { reservation_id: reservation.id, token: "card_error" } }
      ...
      context "payment error" do
        let(:params) { { reservation_id: reservation.id, token: "payment_error" } }
